...
* [Introduction](beacon-chain.md#introduction)
  * [What are proof of stake and sharding and why do they matter?](beacon-chain.md#what-are-proof-of-stake-and-sharding-and-why-do-they-matter)
  * [How does eth2 sharding work?](beacon-chain.md#how-does-eth2-sharding-work)
  * [How does eth2 proof of stake work?](beacon-chain.md#how-does-eth2-proof-of-stake-work)
  * [Phases](beacon-chain.md#phases)
* [Organization and type system](beacon-chain.md#organization-and-type-system)
* [Custom types](beacon-chain.md#custom-types)
* [Constants](beacon-chain.md#constants)
* [Configuration](beacon-chain.md#configuration)
  * [Misc](beacon-chain.md#misc)
  * [Gwei values](beacon-chain.md#gwei-values)
  * [Initial values](beacon-chain.md#initial-values)
  * [Time parameters](beacon-chain.md#time-parameters)
    * [`[Aside: RANDAO, seeds and committee generation]`](beacon-chain.md#aside-randao-seeds-and-committee-generation)
  * [State list lengths](beacon-chain.md#state-list-lengths)
  * [Rewards and penalties](beacon-chain.md#rewards-and-penalties)
  * [Max operations per block](beacon-chain.md#max-operations-per-block)
  * [Domain types](beacon-chain.md#domain-types)
* [Containers](beacon-chain.md#containers)
  * [Misc dependencies](beacon-chain.md#misc-dependencies)
    * [`Fork`](beacon-chain.md#fork)
    * [`ForkData`](beacon-chain.md#forkdata)
    * [`Checkpoint`](beacon-chain.md#checkpoint)
    * [`Validator`](beacon-chain.md#validator)
    * [`AttestationData`](beacon-chain.md#attestationdata)
    * [`IndexedAttestation`](beacon-chain.md#indexedattestation)
    * [`PendingAttestation`](beacon-chain.md#pendingattestation)
    * [`Eth1Data`](beacon-chain.md#eth1data)
    * [`HistoricalBatch`](beacon-chain.md#historicalbatch)
    * [`[Aside: note on the deposit process]`](beacon-chain.md#aside-note-on-the-deposit-process)
    * [`DepositMessage`](beacon-chain.md#depositmessage)
    * [`DepositData`](beacon-chain.md#depositdata)
    * [`BeaconBlockHeader`](beacon-chain.md#beaconblockheader)
    * [`[Aside: domain separation]`](beacon-chain.md#aside-domain-separation)
    * [`SigningData`](beacon-chain.md#signingdata)
  * [Beacon operations](beacon-chain.md#beacon-operations)
    * [`ProposerSlashing`](beacon-chain.md#proposerslashing)
    * [`AttesterSlashing`](beacon-chain.md#attesterslashing)
    * [`Attestation`](beacon-chain.md#attestation)
    * [`Deposit`](beacon-chain.md#deposit)
    * [`VoluntaryExit`](beacon-chain.md#voluntaryexit)
  * [Beacon blocks](beacon-chain.md#beacon-blocks)
    * [`BeaconBlockBody`](beacon-chain.md#beaconblockbody)
    * [`BeaconBlock`](beacon-chain.md#beaconblock)
  * [Beacon state](beacon-chain.md#beacon-state)
    * [`BeaconState`](beacon-chain.md#beaconstate)
  * [Signed envelopes](beacon-chain.md#signed-envelopes)
    * [`SignedVoluntaryExit`](beacon-chain.md#signedvoluntaryexit)
    * [`SignedBeaconBlock`](beacon-chain.md#signedbeaconblock)
    * [`SignedBeaconBlockHeader`](beacon-chain.md#signedbeaconblockheader)
* [Helper functions](beacon-chain.md#helper-functions)
  * [Math](beacon-chain.md#math)
    * [`integer_squareroot`](beacon-chain.md#integer_squareroot)
    * [`xor`](beacon-chain.md#xor)
    * [`uint_to_bytes`](beacon-chain.md#uint_to_bytes)
    * [`bytes_to_uint64`](beacon-chain.md#bytes_to_uint64)
  * [Crypto](beacon-chain.md#crypto)
    * [`hash`](beacon-chain.md#hash)
    * [`hash_tree_root`](beacon-chain.md#hash_tree_root)
    * [BLS Signatures](beacon-chain.md#bls-signatures)
  * [Predicates](beacon-chain.md#predicates)
    * [`[Aside: note on a validator's life cycle]`](beacon-chain.md#aside-note-on-a-validators-life-cycle)
    * [`is_active_validator`](beacon-chain.md#is_active_validator)
    * [`is_eligible_for_activation_queue`](beacon-chain.md#is_eligible_for_activation_queue)
    * [`is_eligible_for_activation`](beacon-chain.md#is_eligible_for_activation)
    * [`is_slashable_validator`](beacon-chain.md#is_slashable_validator)
    * [`is_slashable_attestation_data`](beacon-chain.md#is_slashable_attestation_data)
    * [`is_valid_indexed_attestation`](beacon-chain.md#is_valid_indexed_attestation)
    * [`is_valid_merkle_branch`](beacon-chain.md#is_valid_merkle_branch)
  * [Misc](beacon-chain.md#misc-1)
    * [`compute_shuffled_index`](beacon-chain.md#compute_shuffled_index)
    * [`compute_proposer_index`](beacon-chain.md#compute_proposer_index)
    * [`compute_committee`](beacon-chain.md#compute_committee)
    * [`compute_epoch_at_slot`](beacon-chain.md#compute_epoch_at_slot)
    * [`compute_start_slot_at_epoch`](beacon-chain.md#compute_start_slot_at_epoch)
    * [`compute_activation_exit_epoch`](beacon-chain.md#compute_activation_exit_epoch)
    * [`compute_fork_data_root`](beacon-chain.md#compute_fork_data_root)
    * [`compute_fork_digest`](beacon-chain.md#compute_fork_digest)
    * [`compute_domain`](beacon-chain.md#compute_domain)
    * [`compute_signing_root`](beacon-chain.md#compute_signing_root)
  * [Beacon state accessors](beacon-chain.md#beacon-state-accessors)
    * [`get_current_epoch`](beacon-chain.md#get_current_epoch)
    * [`get_previous_epoch`](beacon-chain.md#get_previous_epoch)
    * [`get_block_root`](beacon-chain.md#get_block_root)
    * [`get_block_root_at_slot`](beacon-chain.md#get_block_root_at_slot)
    * [`get_randao_mix`](beacon-chain.md#get_randao_mix)
    * [`get_active_validator_indices`](beacon-chain.md#get_active_validator_indices)
    * [`get_validator_churn_limit`](beacon-chain.md#get_validator_churn_limit)
    * [`get_seed`](beacon-chain.md#get_seed)
    * [`get_committee_count_per_slot`](beacon-chain.md#get_committee_count_per_slot)
    * [`get_beacon_committee`](beacon-chain.md#get_beacon_committee)
    * [`get_beacon_proposer_index`](beacon-chain.md#get_beacon_proposer_index)
    * [`get_total_balance`](beacon-chain.md#get_total_balance)
    * [`get_total_active_balance`](beacon-chain.md#get_total_active_balance)
    * [`get_domain`](beacon-chain.md#get_domain)
    * [`get_indexed_attestation`](beacon-chain.md#get_indexed_attestation)
    * [`get_attesting_indices`](beacon-chain.md#get_attesting_indices)
  * [Beacon state mutators](beacon-chain.md#beacon-state-mutators)
    * [`increase_balance`](beacon-chain.md#increase_balance)
    * [`decrease_balance`](beacon-chain.md#decrease_balance)
    * [`initiate_validator_exit`](beacon-chain.md#initiate_validator_exit)
    * [`slash_validator`](beacon-chain.md#slash_validator)
* [Genesis](beacon-chain.md#genesis)
  * [Initialize beacon state from Eth1](beacon-chain.md#initialize-beacon-state-from-eth1)
  * [Genesis state](beacon-chain.md#genesis-state)
  * [Genesis block](beacon-chain.md#genesis-block)
* [Beacon chain state transition function](beacon-chain.md#beacon-chain-state-transition-function)
  * [State transition](beacon-chain.md#state-transition)
  * [Epoch processing](beacon-chain.md#epoch-processing)
    * [Helper functions](beacon-chain.md#helper-functions-1)
    * [Justification and finalization](beacon-chain.md#justification-and-finalization)
    * [Rewards and penalties](beacon-chain.md#rewards-and-penalties-1)
      * [Helpers](beacon-chain.md#helpers)
      * [Components of attestation deltas](beacon-chain.md#components-of-attestation-deltas)
      * [`get_attestation_deltas`](beacon-chain.md#get_attestation_deltas)
      * [`process_rewards_and_penalties`](beacon-chain.md#process_rewards_and_penalties)
    * [Registry updates](beacon-chain.md#registry-updates)
    * [`[Aside: anti-correlation penalties in Eth2]`](beacon-chain.md#aside-anti-correlation-penalties-in-eth2)
    * [Slashings](beacon-chain.md#slashings)
    * [Final updates](beacon-chain.md#final-updates)
  * [Block processing](beacon-chain.md#block-processing)
    * [Block header](beacon-chain.md#block-header)
    * [RANDAO](beacon-chain.md#randao)
    * [Eth1 data](beacon-chain.md#eth1-data)
    * [Operations](beacon-chain.md#operations)
      * [Proposer slashings](beacon-chain.md#proposer-slashings)
      * [Attester slashings](beacon-chain.md#attester-slashings)
      * [Attestations](beacon-chain.md#attestations)
      * [Deposits](beacon-chain.md#deposits)
      * [Voluntary exits](beacon-chain.md#voluntary-exits)
...
See [the corresponding section in the phase 1 doc](https://github.com/isabelschoeps-thiel/sia-security-intelligence-artefact/blob/main/phase1/beacon-chain.md#how-does-eth2-sharding-work).
...
Number of rounds in the swap-or-not shuffle; for more info see the [`compute_shuffled_index` function description](beacon-chain.md#compute_shuffled_index) below. Expert cryptographer advice told us `~4*log2(n)` is sufficient for safety; in our case, `n <= 2**22`, hence \~90 rounds.
...
See explanation of the `Version` type [above](beacon-chain.md#Custom-types). The version starting at 0 is self-explanatory (why not 1? Because we're computer scientists, not normal people, doge-dammit!).
...
To see the proposer and committee selection algorithms, which take as input (i) the active validator set and (ii) the seed, and output the current block proposer and the committees, see [here](beacon-chain.md#compute_shuffled_index).
...
See [here](beacon-chain.md#inactivity-quotient) for what the inactivity leak is; this constant simply says that the leaking starts after 4 epochs of non-finality.
...
The eth2 chain contains a Merkle tree of its own historical blocks. This is done using two data structures: (i) a rotating "recent history log" (`state.block_roots` and `state.state_roots`) and (ii) an ongoing accumulator (`state.historical_roots`) which stores Merkle roots of recent history logs. The total state size is optimized if the two have a roughly similar length, both `~sqrt(length of chain)`; setting this to 8192 slots ensures that this condition is satisfied at 67,108,864 slots (= 1,024 eeks, \~= 20 years). If desired, the lengths can be rebalanced after a century to improve efficiency, though the gains will be negligible.Provides a reasonable amount of time to ensure that individual validators that misbehave can be slashed.In phase 1, this is how often the proposer committees on a shard get reshuffled. In phase 0, validators are only allowed to exit if they have been active for at least this long; this prevents spamming the exit queue and repeatedly exiting and re-entering to force oneself into specific shards.State list lengthsHow far back randomness seeds are visible; this is de-facto the maximum amount of time after which a validator can be slashed.This is the minimum amount of time a validator must wait before they can withdraw if they are slashed; during that time, they get penalized an amount proportional to how many other validators get slashed in the same time period.

See the [section on slashings](beacon-chain.md#slashings) for more details, and [here](https://notes.ethereum.org/@vbuterin/rkhCgQteN?type=view#Slashing-and-anti-correlation-penalties) for why this is done.
...
See `get_base_reward` in the section on [helpers](beacon-chain.md#helpers) for details.
...
The following types are [SimpleSerialize (SSZ)](https://github.com/isabelschoeps-thiel/sia-security-intelligence-artefact/blob/main/ssz/simple-serialize.md) containers.
...
The intention is that the "current fork version" equals `state.fork.previous_version` if the current epoch is less than `state.fork.epoch`, and `state.fork.current_version` if the current epoch is equal to or greater than `state.fork.epoch`. The current fork version is mixed into the signed data in all BLS-signed messages (see [`get_domain`](beacon-chain.md#get_domain)).
...
This is a dummy struct that's used to mix in not just the fork version, but also the genesis, in [`get_domain`](beacon-chain.md#get_domain).
...
This is the struct that contains all of the important information relating to a particular validator (except for its exact balance; see the [section on hysteresis above](beacon-chain.md#hysteresis) for info on that). From top to bottom:
...
See the discussion in the [`SLOTS_PER_HISTORICAL_ROOT`](beacon-chain.md#slots_per_historical_root) section above.
...
**`[Aside: domain separation]`**&#x44;omain separation in eth2 is done to prevent situations where a signature of an object of one type and context is accidentally a valid signature of an object in a different type or a different context. This could happen because the same data happens to be valid as multiple data types; such situations could conceivably be triggered by attackers to cause slashings or other problems. Domain separation unambiguously makes this impossible.There are two main types of domain separation in eth2:**Cross-chain domain separation**: a message signed for one eth2 chain should not be valid in any other eth2 chain (eg. mainnet vs testnet, testnet vs another testnet, a hypothetical eth2 vs "eth2 classic" fork)**Cross-context domain separation**: a signature of an attestation should not be valid as a signature of a beacon block, etc.

We achieve domain separation by mixing in a domain hash whenever we sign a message; that is, when we sign some `object`, we're really signing `hash(root_hash(object), domain_hash)`. The domain hash itself mixes together the `domain_type` and the `fork_version` (representing the chain), see [`get_domain`](beacon-chain.md#get_domain) for the logic of how this works.

The `domain_type` is a 4-byte value; see [the list of domain types](beacon-chain.md#Domain-types). The `fork_version` (think of this as like a chain ID, except it changes every hard fork to facilitate replay protection during deliberate ETH/ETC-like splits) is computed based on the logic described [above in the section on forks](beacon-chain.md#Fork).
...
Eth2 heavily makes use of **signed containers**: structures where there is some inner container `C1`, and an outer container `C2(message: C1, signature: BLSSignature)`. To implement domain separation (see [the section above](beacon-chain.md#domain_separation)), instead of directly signing the root hash of the message being signed, the signature signs over the root hash of a struct containing that message and the domain (computed via [`get_domain`](beacon-chain.md#get_domain)).
...
`def hash_tree_root(object: SSZSerializable) -> Root` is a function for hashing objects into a single root by utilizing a hash tree structure, as defined in the [SSZ spec](https://github.com/isabelschoeps-thiel/sia-security-intelligence-artefact/blob/main/ssz/simple-serialize.md#merkleization).
...
_Note_: The non-standard configuration of the BLS and hash to curve specs is temporary and will be resolved once IETF releases BLS spec draft 3.
...
* A penalty proportional to the portion of other validators that get slashed (see the [`process_slashings` function](beacon-chain.md#Slashings))
...
With this background (see also the [Validator struct definition](beacon-chain.md#Validator), hopefully the next four functions are reasonably self-explanatory:
...
Note that the activation queue only processes activations that were registered before the last finalized block that the beacon chain knows about; see [the section on registry updates](beacon-chain.md#Registry-updates) for more information on this.
...
We use the "swap-or-not" algorithm from https://link.springer.com/content/pdf/10.1007%2F978-3-642-32009-5\_1.pdf, which efficiently satisfies all of the above properties.
...
A helper function used by [`get_domain`](beacon-chain.md#get_domain). Combines together domain type and fork version (see [the section on forks](beacon-chain.md#Fork)) into a `Domain` object.

See also [the section on domain separation](beacon-chain.md#domain_separation).
...
See the [section on churn](beacon-chain.md#churn).
...
See also: the [section on randomness seeds](beacon-chain.md#seeds).
...
Returns the domain hash (data which gets mixed in with a message being signed) for a particular `DomainType`. This is used to implement domain separation; see [the section on domain separation](beacon-chain.md#domain_separation) for more info.
...
_Note_: The ETH1 block with `eth1_timestamp` meeting the minimum genesis active validator count criteria can also occur before `MIN_GENESIS_TIME`.
...
def process\_slot(state: BeaconState) -> None:    # Cache state root    previous\_state\_root = hash\_tree\_root(state)    state.state\_roots\[state.slot % SLOTS\_PER\_HISTORICAL\_ROOT] = previous\_state\_root    # Cache latest block header state root    if state.latest\_block\_header.state\_root == Bytes32():        state.latest\_block\_header.state\_root = previous\_state\_root    # Cache block root    previous\_block\_root = hash\_tree\_root(state.latest\_block\_header)    state.block\_roots\[state.slot % SLOTS\_PER\_HISTORICAL\_ROOT] = previous\_block\_rootThe main function of the `process_slot` function is to update the historical `block_roots` and `state_roots` arrays. The state root manipulation is needed as a clever trick to get around a challenging issue. Namely, we want to include the root of the block at slot `n` into the history in slot `n`. The most natural time to do this is, well, when we are processing the block. But this poses a problem to the block creator: the post-state root of the block can only be generated after the state transition is fully processed, but including the block root into the history during slot `n` would require the block's post-state root to be known during the state transition!We get around this via the following tactic. While processing the block at slot `n` (in `process_block`), we add the block header but zero out the state root. Then, at the beginning of the `process_slot` function of slot N+1 (at which point the state has not yet been modified after it was processed in slot `n`), we edit the saved block header and fill in the post-state root.Note that this requires an extra data structure, `state.latest_block_header`, even though we only _really_ care about storing historical roots; the complexity increase here was deemed worth it to keep the state transition function itself a clean `state_transition(state, block) -> new_state` (as opposed to requiring the previous block as an explicit argument).Epoch processingdef process\_epoch(state: BeaconState) -> None:    process\_justification\_and\_finalization(state)    process\_rewards\_and\_penalties(state)    process\_registry\_updates(state)    process\_slashings(state)    process\_final\_updates(state)At the epoch boundary (ie. after the end of the last slot of an epoch), we perform a set of procedures, largely around processing the `PendingAttestations` that have been saved up in the current and previous epoch, though there is also some other work that gets done.First, we define some helper functions:**Helper functions**def get\_matching\_source\_attestations(state: BeaconState, epoch: Epoch) -> Sequence\[PendingAttestation]:    assert epoch in (get\_previous\_epoch(state), get\_current\_epoch(state))    return state.current\_epoch\_attestations if epoch == get\_current\_epoch(state) else state.previous\_epoch\_attestations

When [processing attestations](beacon-chain.md#Attestations), we already only accept attestations that have the correct Casper FFG source checkpoint (specifically, the most recent justified checkpoint that the chain knows about). The goal of this function is to get all attestations that have a correct Casper FFG source. Hence, it can safely just return all the `PendingAttestation`s for the desired epoch (current or previous).
...
Gets the list of attesting indices from a set of attestations, filtering out the indices that have been slashed. The idea here is that if you get slashed, you are still "technically" part of the validator set (see the [note on the validator life cycle](beacon-chain.md#lifecycle) for reasoning why), but your attestations do not get counted.
...
This code implements the [inactivity leak](beacon-chain.md#inactivity-quotient).
...
**`[Aside: anti-correlation penalties in Eth2]`**&#x49;n eth2, **anti-correlation penalties** are penalties structured in such a way that you get penalized more for the same offense if many other validators perform that same offense at the same time. Anti-correlation penalties are done for a few reasons:It's generally a good economic principle to set the penalty for an action to be proportional to the harm caused by an action, and because of eth2's inherent decentralization, a single validator misbehaving often causes no harm to network performance at all, but a large fraction of validators misbehaving simultaneously can cause serious damage.This technique tries to separate the case where a validator misbehaves due to an honest mistake (internet connection failure, two validator backups accidentally interfering with each other, etc) from the case where validators are trying to actively attack the network. Honest mistakes are only lightly punished, malice is punished to the maximum extent.It creates incentives for validators to make decisions that decorrelate their failures from other validators; for example: not running the same client, not being part of the same staking pool, not running on the same cloud service.We can see one example of how (3) works by considering a scenario where there are two staking pools (or cloud services, or clients), one with 10% of the total stake and the other with 20% of the total stake. Suppose that the two have the same reliability; that is, each of them has the same chance of failing in any given time period. However, because of anti-correlation penalties, the second pool would suffer penalties twice as high, because the fact that 20% of validators fail instead of 10% itself doubles the penalties for each validator. Hence, for a new user, it becomes less risky to join the first pool.There are two main types of anti-correlation penalties in eth2:

* The [**inactivity leak**](beacon-chain.md#inactivity-quotient): if you fail to produce an attestation, you normally get a small penalty, but if you do so when the chain is failing to finalize (ie. when >1/3 of other validators are failing to produce attestations), the penalties become much larger. This mechanism does have another purpose of ensuring the chain returns to a status where it can finalize, but it does serve the anti-correlation penalty function as well.
...
* Updating validators' effective balances based on changes to their exact balances (see [the section on hysteresis](beacon-chain.md#hysteresis) for more details)
...
This is fairly self-explanatory; just checking a few basic correctness properties of the block, and storing the block header in the cache without its state root (as we don't know its state roots yet; see [the section on `process_slot`](beacon-chain.md#process_slot_notes) to understand more fully what's going on there).
...
See [the section on seeds](beacon-chain.md#seeds) to understand what's going on here.
